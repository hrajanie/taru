...
echo "       new world <name>   — birth your own world (engine/WORLD.md); have pages"
echo "                            already? point worlds/<name>/sources.md at them and"
echo "                            say 'absorb sources' (README: door two)"
echo "       prep               — or, to continue Qelán from scene 008: let a fresh"
echo "                            back room author its own hidden world first,"
echo "       scene in qelan       then sit down at the table."
echo
